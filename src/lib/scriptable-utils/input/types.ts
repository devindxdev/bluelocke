export type TextFieldKeyboardFlavor = 'default' | 'number' | 'email' | 'phone' | 'url'
...
export type AlertOpts<TextFieldKey extends string = string, ButtonKey extends string = string> = {
  title: string
  message?: string
