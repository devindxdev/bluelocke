...
const style = ({
  ...
  bgColor,
  ...rest
}: MapVals<CascadingStyle & RowStyle, { color?: Color | ColorKey; bgColor?: Color | ColorKey }>): CascadingStyle &
  RowStyle => ({
  ...rest,
...
const FLAVOR_TRANSPARENT = () => style({ bgColor: 'bg', color: 'primaryTextColor' })
