...
<div class="install-flow">
  <a class="install-flow-btn" href="https://apps.apple.com/us/app/scriptable/id1405459188?uo=4" target="_blank" rel="noopener noreferrer">
    <span class="install-flow-link-indicator" aria-hidden="true">↗</span>
    ...
    <span class="install-flow-step">Step 1</span>
    <span class="install-flow-label">Install Scriptable</span>
    <span class="install-flow-sub">Download Scriptable from the App Store.</span>
  </a>
  ...
  <a class="install-flow-btn" href="https://github.com/devindxdev/bluelocke/releases/latest/download/bluelocke.js" target="_blank" rel="noopener noreferrer">
    ...
    <span class="install-flow-step">Step 2</span>
    <span class="install-flow-label">Direct Download</span>
    <span class="install-flow-sub">Download the latest <code>bluelocke.js</code>.</span>
  </a>

  <div class="install-flow-btn install-flow-static">
    <span class="install-flow-icon" aria-hidden="true">
    ...
    <span class="install-flow-label">Move Into Scriptable Folder</span>
    <span class="install-flow-sub">In Files, move <code>bluelocke.js</code> to:</span>
    <code class="install-path">iCloud Drive/Scriptable</code>
  </div>
</div>

![GitHub release page showing the bluelocke.js file in release assets](./images/install-release-download.png)
